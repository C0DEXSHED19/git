...
import { CustomersTable } from 'src/sections/customer/history-tablebarber';
...
export async function getServerSideProps(){
  // here we kept barber id in path
  try {
    const response = await axios.get('http://localhost:8080/api/v1/appointments/2/profile/appointmentsHistory');
